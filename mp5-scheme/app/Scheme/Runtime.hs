...
evalPrim [list] = eval list
evalPrim other = throwError $ UnexpectedArgs other
...
isList [list] = case flattenList list of Right [] -> return $ Boolean True 
                                         _ -> return $ Boolean False
isList other = throwError $ UnexpectedArgs other
...
isSymbol other = throwError $ UnexpectedArgs other
...
isBoolean other = throwError $ UnexpectedArgs other
